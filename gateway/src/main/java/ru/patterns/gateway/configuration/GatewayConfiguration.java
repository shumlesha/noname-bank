...
public class GatewayConfiguration {
    private final TokenRelayGatewayFilterFactory tokenRelayFactory;
    ...
    public RouteLocator customRouteLocator(RouteLocatorBuilder builder) {
        return builder.routes()
                ...
                .route("user-service", r -> r.path("/api/users/**")
                        .filters(f -> f
                                .filter(tokenRelayFactory.apply(new Object()))
                ...
                .route("client-interface", r -> r.path("/client/**")
                        .filters(f -> f.filter(tokenRelayFactory.apply(new Object())))
                        .uri("lb://client-interface"))
